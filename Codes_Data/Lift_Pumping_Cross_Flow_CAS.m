function [P_input_LIFT, M_SS_LIFT] = Lift_Pumping_Cross_Flow(Q_mgd,N_train)
% Input:
...
NP_LIFT = 2; % # of lift pumps in duty (1 WAS and 1 RAS pump/clarifier)

% --> Static head
H_ss_LIFT = 0; % [ft] Suction Static Head
H_ds_LIFT = 12; % [ft] Discharge Static Head
